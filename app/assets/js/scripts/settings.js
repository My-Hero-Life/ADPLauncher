    ...
    authKeys.forEach((val) => {
        ...
        const accHtml = `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="https://crafatar.com/renders/body/${acc.uuid}">
            </div>
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/My-Hero-Life/ADPLauncher/releases.atom',
        success: (data) => {
